...
for(var e="",a=0;a<r.length;a++){var i=r[a],o=i[0],u=i[1]
e+=L+U+t(o)+U+t(u)+U+Q
for(var c=2;c<i.length;c+=6){var f=i[c],l=i[c+1],v=i[c+2],s=i[c+3],h=i[c+4],p=i[c+5],g=o===h&&o===f&&o===v,y=u===p&&u===l&&u===s
g&&y||(o=h,u=p,e+=U+t(f)+U+t(l)+U+t(v)+U+t(s)+U+t(h)+U+t(p))}}return e}function e(){throw new Error(Array.prototype.join.call(arguments,U))}function a(r,n){for(var t in n)r.hasOwnProperty(t)||(r[t]=n[t])
